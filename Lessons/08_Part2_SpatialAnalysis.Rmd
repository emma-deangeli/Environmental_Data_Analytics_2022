...
neuse <- st_read('./Data/Spatial/NCHUC8.shp') %>%
...
ggplot() +
  ...
  geom_sf(data = neuse, fill='purple')
...
EnviroAtlas <- read.csv(
  'https://raw.githubusercontent.com/ENV859/EnviroAtlasData/main/Wind_Energy.csv', colClasses = c('HUC_12' = 'factor'))


#Join to HUC_8 features -- don't know how at all

HUC_sf_join <-  merge(x = huc8_sf,
                           y = EnviroAtlas, 
                           by.x = "HUC_8", 
                           by.y = "HUC_12" )
