...
# ANOVA is robust against departures from equal variance... as in, it works even when there is not equal variance
...
> This shows the means of the dry mass and whether or not they're significantly different based upon different groupings.
