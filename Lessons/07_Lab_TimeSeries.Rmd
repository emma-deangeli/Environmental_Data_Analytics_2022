...
# Temp definitely increases but it's more unclear with rainfall. There might be a slight increase.
```
...
Rainfall_ts <- ts(BRA_complete$Rainfall, start = c(1901,1), frequency = 12)

Temp_ts <- ts(BRA_complete$Temperature_C, start = c(1901,1), frequency = 12)
...
# The temp trend is definitely upward. The other plots are very weird. The rainfall trend is still unclear.
...
Rainfall_trend1 <- Kendall::SeasonalMannKendall(Rainfall_ts)
Rainfall_trend1
summary(Rainfall_trend1)
