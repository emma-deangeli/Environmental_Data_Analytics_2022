...
<<<<<<< HEAD
setwd("/Users/Emma DeAngeli/Documents/Environmental Data Analytics")
=======
...
> Answer: There is a lot going on! Most of the text is mentioning that packages were built under a certain R version.
...
> ANSWER: It's under the metadata file. This helps us understand the data, and that way people could track why we chose to clean up the data in the ways that we do.
...
> Answer: If it is a time series with lots of older data that would have a lot of NAs, then it would be more favorable to remove the NAs. If there are not a lot of NAs, it may be favorable to maintain them.
